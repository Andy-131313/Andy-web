  ...
  return (
    ...
    >
      ...
      >
        ...
        {isHovered && (
          <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 px-2 py-1 bg-zinc-900/95 backdrop-blur-sm rounded text-xs text-white whitespace-nowrap pointer-events-none">
            {label}
          </div>
        )}
      </div>
...
export default function OrbitingSkills() {
  ...
  return (
    <section className="relative w-full flex items-center justify-center py-20 md:py-32 bg-[#090909] overflow-hidden">
      {/* Background subtle radials */}
      ...
      >
        {/* Central icon */}
        <div className="w-20 h-20 bg-gradient-to-br from-zinc-700 to-zinc-900 rounded-full flex items-center justify-center z-10 relative shadow-2xl">
