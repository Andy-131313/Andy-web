...
export const HeroSection = () => {
  ...
  return (
    ...
    >
      {/* 3D Canvas — absolute so it only covers this section */}
      ...
      >
        ...
        <div className="flex-1 min-w-0 flex flex-col justify-between pb-12 md:pb-8 w-full">
          ...
          <div className="max-w-4xl lg:-translate-y-8 pr-12">
            <h1 className="text-[clamp(3.5rem,9.5vw,11.5rem)] font-black leading-[0.87] tracking-tighter text-white uppercase">
              JAN <br />
              <span className="text-outline">ANDRÝSEK</span>
            </h1>
            <p className="mt-8 font-mono text-[11px] text-white/40 uppercase tracking-[0.35em] max-w-sm leading-relaxed">
              Vytvářím moderní weby a digitální zážitky s důrazem na design a
              detail.
            </p>
          </div>
          ...
          >
            <div className="w-14 h-14 rounded-full border border-indigo-500/30 flex items-center justify-center group-hover:bg-indigo-500 transition-all duration-500 overflow-hidden">
              <svg
                width="18"
                height="18"
                viewBox="0 0 24 24"
                ...
                className="group-hover:stroke-white stroke-indigo-400 transition-colors duration-500"
              >
                <path
        ...
        <div className="w-full md:w-80 lg:w-96 flex-shrink-0 flex flex-col gap-4 justify-center z-20">
          {[
            ...
            <div
              key={item.id}
              className="command-cell glass-panel p-6 sm:p-7 block"
            >
      ...
      {/* Scanline overlay */}
      <div className="absolute inset-0 pointer-events-none bento-mask opacity-10 z-[100]" />
    </section>
  );
};
